...
$$ 0 < P(\bar{j}\rightarrow \bar{j}) < 1$$

(, since it will not be an irreducible Markov Chain if otherwise!)

and that,

$$0 \le P(i \rightarrow \bar{j}) \le 1$$

Because there are only finite number of states,
